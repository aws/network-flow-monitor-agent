...
pub const SK_STATS_TO_PROPS_MAX_RATIO: u64 = 10;
...
pub const SK_STATS_TO_PROPS_RATIO_CPU_COUNT_DIVISOR: usize = 3;

// This divisor was chosen arbitrarily based on experimentation. (5 GBytes)
...
//   Stats: 768 / 5 * 500 -> 76.8k entries for stats)
//   Props: Ratio = (192 / 3 = 64 -> clamped to 10) -> 76.8 / (10) -> 7.68k
pub const MAX_ENTRIES_SK_STATS_LO: u64 = 500;
pub const MAX_ENTRIES_SK_STATS_HI: u64 = 100000;
