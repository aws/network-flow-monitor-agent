...
pub struct EventCounters {
    ...
    pub props_insertion_errors: u32,
    pub stats_insertion_errors: u32,
...
impl EventCounters {
    ...
    pub fn get_insertion_errors_sum(&self) -> u32 {
        self.props_insertion_errors + self.stats_insertion_errors
    }
}
...
mod tests {
    ...
    fn test_event_counters_rollover() {
        ...
        let original = EventCounters {
            ...
            props_insertion_errors: u32::MAX - 18,
            stats_insertion_errors: u32::MAX - 19,
